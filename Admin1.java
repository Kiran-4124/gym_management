        ...
        btnCreate.addActionListener(e -> {
            ...
            try {
                if(trainer.isSelected()) {
                    ...
                    // Insert into members table (MEMBERSHIP NOT NULL)
                    String queryMember = "INSERT INTO members (id, name, age, mobile, gender, weight, height, membership, password, time) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                    PreparedStatement pstMember = conn.prepareStatement(queryMember);
                    pstMember.setString(1, id);
                    pstMember.setString(2, name);
                    pstMember.setString(3, age);
                    pstMember.setString(4, mobile);
                    pstMember.setString(5, gender);
                    pstMember.setString(6, weight);
                    pstMember.setString(7, height);
                    pstMember.setString(8, membershipValue);  // REQUIRED
                    pstMember.setString(9, password);
                    pstMember.setString(10, time);
