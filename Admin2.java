...
public class Admin2 extends JFrame {
    // Declare fields globally for access in actions
    Connection conn;
    ...
    public Admin2() {
        // Open database connection (change credentials as needed)
        try {
            conn = DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/gym_fit", // change if needed
        ...
        submitButton.addActionListener(e -> {
            ...
            try {
                ...
                if(rs.next()) {
                    ...
                    // Membership is left unselected
                } else {
                    JOptionPane.showMessageDialog(this, "No Trainer found with this ID!");
                }
                rs.close(); ps.close();
            } catch(Exception ex) {
        ...
        deleteButton.addActionListener(e -> {
            ...
            int confirm = JOptionPane.showConfirmDialog(this,
                "Really delete this trainer and user?",
